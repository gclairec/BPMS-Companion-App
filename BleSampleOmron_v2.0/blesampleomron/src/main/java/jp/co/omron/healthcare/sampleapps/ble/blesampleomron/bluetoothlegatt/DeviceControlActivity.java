...
//        mDataField.setText(com.example.android.bluetoothlegatt.R.string.no_data);
    ...
    public void onClickWrite(View v){
        if (mBluetoothLeService != null) {
//            mBluetoothLeService.writeCustomCharacteristic(BlsActivity.espData);
//            int cnt;
            mBluetoothLeService.writeCustomCharacteristic(BlsActivity.espData);
//            if(mBluetoothLeService.writeCustomCharacteristic("0ABCDEFGHIJ") == true)
//            {
//                if(mBluetoothLeService.writeCustomCharacteristic("1" + BlsActivity.timestampStr) == true)
//                {
//                    mBluetoothLeService.writeCustomCharacteristic("2" + Float.toString(BlsActivity.systolicVal)+Float.toString(BlsActivity.diastolicVal));
//                }
//            }
        }
    }
