...
public class UserNavDrawer extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            SharedPreferences.Editor sharedPrefNotifEditor = sharedPrefNotif.edit();
            sharedPrefEditor.clear();
            sharedPrefEditor.commit();
            sharedPrefNotifEditor.clear();
            sharedPrefNotifEditor.commit();
            Toast.makeText(this, "Data Cleared, App unpaired", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(UserNavDrawer.this, SplashActivity.class);
